  ...
  return (
    <motion.div variants={variants} className={`h-full ${className}`}>
      ...
      >
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-80 transition-opacity duration-300 group-hover:opacity-100" />
        ...
        <div className="absolute bottom-0 left-0 w-full p-6 flex flex-col justify-end h-full">
          <div className="transform transition-transform duration-300 group-hover:-translate-y-2">
            ...
            <h3 className="text-2xl font-bold text-white leading-tight mb-1 drop-shadow-md">{title}</h3>
