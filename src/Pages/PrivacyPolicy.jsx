...
import { fetchPolicyContent } from '../services/generalService';
...
const PrivacyPolicy = () => {
  ...
  useEffect(() => {
    const load = async () => {
      setLoading(true);
      setError(null);
      const html = await fetchPolicyContent();
      if (html) {
  ...
  if (error) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center px-4">
        ...
        <Link to="/" className="px-6 py-3 bg-black text-white rounded-xl font-bold">Back Home</Link>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative">
        ...
        <h1 className="text-3xl font-black mb-6 mt-5">Privacy Policy</h1>
