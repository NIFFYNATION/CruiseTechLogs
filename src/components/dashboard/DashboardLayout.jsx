...
const DashboardLayout = () => {
    ...
    useEffect(() => {
      const chatway = document.querySelector('.chatway--trigger-icon-container');
      if (chatway) {
    ...
    return (
      <SidebarProvider>
        ...
        <style>{`.chatway--trigger-icon-container { bottom: 120px !important;  display: none !important; zoom: 0.7; } .live-chat-container { margin-bottom: 170px;} .live-chat-toggle{ margin-bottom: 60px;}`}</style>
